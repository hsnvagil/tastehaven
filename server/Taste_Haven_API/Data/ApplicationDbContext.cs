    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<MenuItem>().HasData(
            new MenuItem
            {
                ...
                Image =
                    "https://tastehavenimages.blob.core.windows.net/tastehaven/merlin_200483841_0edb972a-b86a-4f14-8983-1e50e4977584-superJumbo.jpg",
                Name = "Fried Calamari",
                Price = 12.99,
                SpecialTag = "Popular"
            },
            new MenuItem
            {
                ...
                Image =
                    "https://tastehavenimages.blob.core.windows.net/tastehaven/guacamole-with-crispy-tortilla-chips-23734-1.webp",
            ...
            new MenuItem
            {
                ...
                Image =
                    "https://tastehavenimages.blob.core.windows.net/tastehaven/easy_chocolate_cake_slice-500x375.jpg",
                Name = "Chocolate Cake",
                Price = 6.99,
            ...
            new MenuItem
            {
                ...
                Image =
                    "https://tastehavenimages.blob.core.windows.net/tastehaven/Template-Size-for-Blog-Photos-24.jpg",
                Name = "Cheesecake",
                Price = 7.99,
                SpecialTag = "Classic"
            },
            ...
            new MenuItem
            {
                ...
                Image =
                    "https://tastehavenimages.blob.core.windows.net/tastehaven/Copycat-McDonalds-French-Fries--500x375.webp",
                Name = "French Fries",
                Price = 4.99,
                SpecialTag = "Classic"
            },
